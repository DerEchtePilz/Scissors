...
tasks.generateDevelopmentBundle {
    apiCoordinates.set("io.github.derechtepilz:scissors-api")
    mojangApiCoordinates.set("io.papermc.paper:paper-mojangapi")
    libraryRepositories.set(
        listOf(
            "https://repo.maven.apache.org/maven2/",
            paperMavenPublicUrl,
            // "https://my.repo/", // This should be a repo hosting your API (in this example, 'io.github.derechtepilz:scissors-api')
        )
    )
}
